...
def menu():
    ...
    pygame.mixer.init()
    pygame.mixer.music.load("anim/4.mp3")
...
history_fon = pygame.image.load('anim/history.jpg')
programIcon = pygame.image.load('anim/icon.png')
end = pygame.image.load('anim/gamefon.jpg')
...
while not done:
    ...
    if game_state == "finish":
        results = []
    if player.rect.x == 20 and player.rect.y == 480:
